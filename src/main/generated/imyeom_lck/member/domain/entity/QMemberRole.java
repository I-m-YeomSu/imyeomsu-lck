...
public class QMemberRole extends EntityPathBase<MemberRole> {
    ...
    private static final long serialVersionUID = 1752597658L;
    ...
    public final NumberPath<Long> memberRoleId = createNumber("memberRoleId", Long.class);

    public final imyeom_lck.role.domain.entity.QRole role;
    ...
    public QMemberRole(Class<? extends MemberRole> type, PathMetadata metadata, PathInits inits) {
        ...
        this.role = inits.isInitialized("role") ? new imyeom_lck.role.domain.entity.QRole(forProperty("role")) : null;
    }
